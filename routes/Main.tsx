        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {clearAllData(); storeStringData("lastScreenName", "Onboarding"); navigation.replace("Onboarding");}}
                >
            ...
            <View style={styles.mainContent}>
                <View style={styles.onionContainer}>
                    <Image
                        source={onionImage}
                        style={{ width: screenWidth * 0.5, height: height,marginBottom: 20, shadowColor: "#000",shadowOffset: {
            width: 0,
            height: 4,
        },
        shadowOpacity: 0.15,
